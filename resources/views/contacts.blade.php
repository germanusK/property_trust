                ...
                <div class="w-full h-auto mb-4 md:grid grid-cols-3">
                    ...
                    <div class="w-full md:col-span-1 shadow-md md:h-full py-12 bg-slate-950">
                        <div class="w-full flex flex-wrap justify-evenly py-8">
                            ...
                            <div class="m-4">
                                <a href="https://www.facebook.com/bpropertytrust?mibextid=2JQ9oc" class=" flex w-12 h-12 sm:w-16 sm:h-16 items-center justify-center align-middle text-center rounded-full border bg-slate-300"><span class="fab fa-facebook-f inline text-4xl text-blue-800"></span></a>
                            </div>
                            <div class="m-4">
                                <a href="https://instagram.com/propertytrustgroup?igshid=OGQ5ZDc2ODk2ZA==" class=" flex w-12 h-12 sm:w-16 sm:h-16 items-center justify-center align-middle text-center rounded-full border bg-slate-300"><span class="fab fa-instagram inline text-4xl text-blue-800"></span></a>
                            </div>
                            <div class="m-4">
                                <a href="https://www.tiktok.com/@nkemboris1" class=" flex w-12 h-12 sm:w-16 sm:h-16 items-center justify-center align-middle text-center rounded-full border bg-slate-300"><span class="fab fa-tiktok inline text-4xl text-blue-800"></span></a>
                            </div>
                            <div class="m-4">

...
<body>
    ...
    <div class="w-full">
        <div class="flex justify-center text-center text-base font-semibold my-6">
            <span><a class="text-blue-900" href="{{url('/')}}">Home</a> : <span class="text-blue-600">About Us</span></span>
        </div>
        <div class="w-full py-12">
            <div class="sm:w-5/6 mx-auto flex flex-wrap">
                
                <div class="w-full h-72 md:h-96 my-10 mx-auto self-end relative">
                    <div class="w-full h-full absolute -z-10">
                        <img src="{{ asset('img/shut.jpg') }}" class=" rounded-t-xl w-full h-full object-cover object-center">
                    </div>
                    <div class="w-full h-full rounded flex justify-around overflow-x-auto whitespace-nowrap -mt-12 no-scrollbar">
                        <div class="w-max flex justify-around space-x-2">
                            <div class="w-48 h-72 rounded border-2 border-blue-900 bg-slate-900 bg-opacity-90 relative">
                                <img src="{{asset('img/61.jpg')}}" class="w-full h-full object-cover object-center absolute">
                                <div class="h-full w-full flex flex-col justify-end items-baseline align-baseline absolute z-20">
                                    <div class="font-bold text-lg text-white">Mr. Seko Franko</div><hr>
                                    <div class="text-sm text-slate-200">CEO/Founder</div>
                                </div>
                            </div>
                            <div class="w-48 h-72 rounded border-2 border-blue-900 bg-slate-900 bg-opacity-90 relative">
                                <img src="{{asset('img/61.jpg')}}" class="w-full h-full object-cover object-center absolute">
                ...
                <div class="md:w-9/12 mx-auto text-center my-12 py-3 px-2">
                    <div class="text-center text-slate-900 text-2xl font-semibold mb-6">B-Property Trust <br> <span class="text-sm text-blue-300">Where real property comes home</span></div>
                    <div class=" text-justify text-slate-700 text-xl font-medium my-1">

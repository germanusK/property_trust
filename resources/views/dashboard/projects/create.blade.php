...
@section('content')
    ...
    <div class="w-full">
        ...
        <div class="flex align-middle items-center py-1 bg-slate-950 rounded">
            <h3 class=" mx-auto text-xl font-semibold text-white px-4">Create Project</h3>
        </div>
        <div class="w-full">
                    ...
                    <div class="w-full md:grid grid-cols-2 divide-x divide-slate-600">
                        ...
                        <div class="col-span-1 px-4 py-2">
                            <div class="w-full sm:w-2/3 mx-auto my-2">
                                <img id="_preview" src=""  height="130" class="w-full h-52 rounded-md border border-slate-400" />
                            </div>
                            ...
                            <div class="w-full my-2">
                                ...
                                <input type="tel" name="contact" id="" placeholder=" contact here" class="sm:w-2/3 flex-auto bg-white px-3 bg-opacity-10 rounded text-white text-opacity-60 placeholder-white placeholder-opacity-70 h-11">
                            </div>
                        </div>
                        ...
                        <div class="col-span-1 px-4 py-2">
                            <div class="w-full my-2">
                                ...
                                <input type="email" name="email" id="" placeholder=" email here" class="sm:w-2/3 flex-auto bg-white px-3 bg-opacity-10 rounded text-white text-opacity-60 placeholder-white placeholder-opacity-70 h-11">
                            </div>
                            <div class="w-full my-2">
                            ...
                            <div class="w-full my-2">
                                ...
                                <input type="file" required name="images" multiple accept="mimes:png,jpg,jpeg,gif,tif" oninput="preview(event)" id="" placeholder="image" class="sm:w-2/3 flex-auto bg-white px-3 bg-opacity-10 rounded text-white text-opacity-60 placeholder-white placeholder-opacity-70 h-11 py-2">
                            </div>
...
@section('script')
    <script>
        let preview = function(event){
            ...
            document.getElementById('_preview').src = url;
        }
    </script>
@endsection
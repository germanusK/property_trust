...
<div class="w-full">
    ...
    <div class="w-full">
        ...
        <div class="w-full items-center justify-center py-6">
            <!-- <form action="{{ url('/rest/property/create') }}" enctype="multipart/form-data" method="post" class="rounded-md bg-white bg-opacity-10 py-10 px-6 w-4/5 sm:3/5 mx-auto border-x border-blue-900 border-opacity-30"> -->
            <form id="creationForm" action="" enctype="multipart/form-data" method="post" class="rounded-md bg-slate-200 shadow-md py-10 px-6 w-4/5 sm:3/5 mx-auto border-x border-black border-opacity-30">
                <div class="flex align-middle items-center pb-5 bg-opacity-20 rounded">
                    <h3 class=" mx-auto text-xl font-semibold text-slate-900 px-4">Create Grade</h3>
                </div>
                        {{@csrf_field()}}
                <div class="w-full flex flex-wrap items-start justify-evenly">
                    <div class="w-full my-2 flex flex-wrap">
                        ...
                        <input type="text" name="name" required id="" placeholder="item name here" class="sm:w-2/3 flex-auto bg-white bg-opacity-10 rounded text-blue-900 text-opacity-60 placeholder-blue-900 placeholder-opacity-70 h-11">
                    </div>
                    
                    <div class="w-full my-2 flex flex-wrap">
                        <label for="description" class="text-blue-900 text-opacity-50 text-base capitalize sm:w-1/3">description:</label><br>
                        <textarea rows="4" name="description" id="" placeholder="item description here" class="sm:w-2/3 flex-auto bg-white bg-opacity-10 rounded text-blue-900 text-opacity-60 placeholder-blue-900 placeholder-opacity-70"></textarea>
                    </div>               
                </div>

...
<div class="w-full xs:h-40 md:h-96 relative bg-transparent">
    ...
    <div class="w-2/5 absolute flex top-0 right-0 border-b-8 border-l-8 rounded-bl-full border-white z-20 bg-blue-500 justify-center items-center align-middle flex-wrap pl-4 py-4">
        ...
        <a href="{{ url('/login') }}" class="mx-4"><span class="text-4xl font-sans mx-5 text-blue-900 fas fas fa-sign-in-alt"></span></a>
    </div>
</div>
<script>

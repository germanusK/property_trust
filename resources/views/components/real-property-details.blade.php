<div class="bg-white">
    <div class="w-11/12 md:w-5/6 mx-auto my-3 rounded-md flex flex-wrap align-middle items-center bg-stone-900">
        ...
        <div class="w-3/4 md:w-1/3 h-full flex align-middle items-center justify-center px-2 mx-auto py-4 overflow-y-scroll no-scrollbar bg-slate-800 bg-opacity-30">

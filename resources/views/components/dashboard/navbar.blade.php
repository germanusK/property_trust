...
<div class="dark:bg-zinc-800 [&>*]:leading-[1.6]">
  ...
  <div class="h-screen w-screen bg-zinc-50 text-center">
    <div
      ...
      <button
        id="toggler"
        class="m-12 inline-block rounded bg-primary px-6 py-2.5 text-xs font-medium uppercase leading-tight text-white shadow-md transition duration-150 ease-in-out hover:bg-primary-700 hover:shadow-lg focus:bg-primary-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-primary-800 active:shadow-lg"

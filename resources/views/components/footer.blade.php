<!-- FOOTER GALLERY -->
<div
  class="bg-neutral-200 text-center text-white dark:bg-neutral-600 dark:text-neutral-200">
...
<footer
  ...
  <div class="bg-neutral-200 p-6 text-center dark:bg-neutral-700">
    ...
    <a class="font-semibold text-neutral-600 dark:text-neutral-400" href="https://tailwind-elements.com/">Property Trust Group</a>
  </div>
</footer>